function BCI_trainBin(varargin)
...
global dtr;
global dtq;
global slct; slct = [1 1 2 2]; slct = slct(randperm(length(slct)));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function on_close(varargin)        
        try 
            ...
            window = 400;
            [filtdata,powdata] = trainAnalyse(EEGdata,window); %any training classification function can be inserted
